...
typedef enum
{
	...
	ID_Param_InitPresetParams                    = 0x40,
	ID_Param_InitInternalParams                  = 0x50,
	ID_Param_InitAlgo2GParams                    = 0x70,
	...
	ID_Param_SetAlgo2GParams                     = 0xA6,

    ID_Cmd_Reset                                 = 0xB0,
    ID_Cmd_MoveLoad                              = 0xB1,
    ID_Cmd_MoveTune                              = 0xB2,
    ID_Cmd_MoveAux                               = 0xB3,
    ID_Cmd_GOTOPreset                            = 0xB4,
    ID_Cmd_Regrease                              = 0xB5,
    ID_Cmd_Index                                 = 0xB6,
    ID_Cmd_ClrLastTuneTime                       = 0xB7,
    ID_Cmd_VDCRelaySw                            = 0xB8,
    ID_Cmd_Mute                                  = 0xB9,
    ID_Cmd_Sync                                  = 0xBA,
	ID_Cmd_FactorMode                            = 0xBB,
	ID_Cmd_ResumeDefaultParam                    = 0xBC,
