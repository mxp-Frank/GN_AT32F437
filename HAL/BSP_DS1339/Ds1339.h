...
#define IIC3_SCL_HIGH()   		IF_GpioOutPut(IIC3_SCL_GPIO, IIC3_SCL_Pin85_PD14, 1, LOGIC_POUT)
#define IIC3_SCL_LOW()    		IF_GpioOutPut(IIC3_SCL_GPIO, IIC3_SCL_Pin85_PD14, 0, LOGIC_POUT)

#define IIC3_SDA_HIGH()   		IF_GpioOutPut(IIC3_SDA_GPIO, IIC3_SDA_Pin86_PD15, 1, LOGIC_POUT)
#define IIC3_SDA_LOW()    		IF_GpioOutPut(IIC3_SDA_GPIO, IIC3_SDA_Pin86_PD15, 0, LOGIC_POUT)

#define IIC3_SDA_READ()    		IF_GpioInPut(IIC3_SDA_GPIO,  IIC3_SDA_PIN, ACTIVE_HIGH)
