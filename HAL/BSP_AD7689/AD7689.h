...
#define AD7689_CNV_LOW         	IF_OutPutGpio_Write(AD7689_CNV_ADC_GPIO, AD7689_CNV_ADC_PIN, 0, LOGIC_POUT)
#define AD7689_CNV_HIGH        	IF_OutPutGpio_Write(AD7689_CNV_ADC_GPIO, AD7689_CNV_ADC_PIN, 1, LOGIC_POUT)

#define AD7689_SCK_LOW 	     	IF_OutPutGpio_Write(AD7689_SCK_ADC_GPIO, AD7689_SCK_ADC_PIN, 0, LOGIC_POUT)
#define AD7689_SCK_HIGH 	    IF_OutPutGpio_Write(AD7689_SCK_ADC_GPIO, AD7689_SCK_ADC_PIN, 1, LOGIC_POUT)

#define AD7689_DIN_LOW 	     	IF_OutPutGpio_Write(AD7689_DIN_ADC_GPIO, AD7689_DIN_ADC_PIN, 0, LOGIC_POUT)
#define AD7689_DIN_HIGH 	    IF_OutPutGpio_Write(AD7689_DIN_ADC_GPIO, AD7689_DIN_ADC_PIN, 1, LOGIC_POUT)

#define AD7689_SDO_VALUE    	IF_InPutGpio_Read(AD7689_SDO_ADC_GPIO,  AD7689_SDO_ADC_PIN, ACTIVE_HIGH)
#if defined(__cplusplus)
}
#endif /* __cplusplus */
