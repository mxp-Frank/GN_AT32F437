...
#define SCL_HIGH()   		IF_GpioOutPut(IIC2_SCL_GPIO, IIC2_SCL_PIN, 1, LOGIC_POUT)
#define SCL_LOW()    		IF_GpioOutPut(IIC2_SCL_GPIO, IIC2_SCL_PIN, 0, LOGIC_POUT)

#define SDA_HIGH()   		IF_GpioOutPut(IIC2_SDA_GPIO, IIC2_SDA_PIN, 1, LOGIC_POUT)
#define SDA_LOW()    		IF_GpioOutPut(IIC2_SDA_GPIO, IIC2_SDA_PIN, 0, LOGIC_POUT)

#define SDA_READ()    		IF_GpioInPut(IIC2_SDA_GPIO, IIC2_SDA_PIN, ACTIVE_HIGH)
